...
function AssignmentsGroup({ label, GroupedTasks, SubjectMap, onUpdateTask, onArchiveTask, events }) {
...
function AssignmentsCard({ task, SubjectMap, onUpdateTask, onArchiveTask, events }) {
